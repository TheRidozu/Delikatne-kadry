...
import {
  StyledPolicyPrivacySection,
  StyledPolicySubList,
  StyledPolicyH2,
  StyledLink,
} from "./StyledPolicyPrivacySection"

const PolicyPrivacySection = () => {
  return (
    <StyledPolicyPrivacySection>
      <h1>Polityka prywatności</h1>
      <StyledPolicyH2>1. Informacje ogólne</StyledPolicyH2>
      <ol>
        <li>
          Niniejsza polityka dotyczy Serwisu www, funkcjonującego pod adresem
          url: delikatnekadry.pl
        </li>
        <li>
          Operatorem serwisu oraz Administratorem danych osobowych jest: Justyna
          Kokot-Wlazły Brzezińska 56, 42-208, Częstochowa
        </li>
        <li>
          Adres kontaktowy poczty elektronicznej operatora:
          subtelnekadry@gmail.com
        </li>
        <li>
      ...
      <StyledPolicyH2>3. Hosting</StyledPolicyH2>
      <ol>
        <li>
      ...
      <StyledPolicyH2>5. Informacje w formularzach</StyledPolicyH2>
      <ul>
        <li>
      ...
      <StyledPolicyH2>6. Logi Administratora</StyledPolicyH2>
      <ol>
        <li>
      ...
      <StyledPolicyH2>7. Istotne techniki marketingowe</StyledPolicyH2>
      <ol>
        <li>
      ...
      <StyledPolicyH2>8. Informacja o plikach cookies</StyledPolicyH2>
      <ol>
      ...
      <ol>
        ...
        <StyledPolicySubList>
          <li>
            <StyledLink href="https://support.microsoft.com/pl-pl/microsoft-edge/wy%C5%9Bwietlanie-i-usuwanie-historii-przegl%C4%85darki-w-programie-microsoft-edge-00cf7943-a9e1-975a-a33d-ac10ce454ca4">
              Edge
            </StyledLink>
          </li>
          <li>
            <StyledLink href="https://support.microsoft.com/pl-pl/topic/jak-usun%C4%85%C4%87-pliki-cookie-w-programie-internet-explorer-bca9446f-d873-78de-77ba-d42645fa52fc">
              Internet Explorer
            </StyledLink>
          </li>
          <li>
            <StyledLink href="https://support.google.com/chrome/answer/95647?hl=pl">
              Chrome
            </StyledLink>
          </li>
          <li>
            <StyledLink href="support.apple.com/kb/PH5042">Safari</StyledLink>
          </li>
          <li>
            <StyledLink href="support.mozilla.org/pl/kb/W%C5%82%C4%85czanie%20i%20wy%C5%82%C4%85czanie%20obs%C5%82ugi%20ciasteczek">
              Firefox
            </StyledLink>
          </li>
          <li>
            <StyledLink href="https://help.opera.com/pl/latest/web-preferences/#cookies">
              Opera
            </StyledLink>
          </li>
        </StyledPolicySubList>
      ...
      <StyledPolicySubList>
        ...
        <li>
          <StyledLink href="https://support.apple.com/pl-pl/HT201265">
            Safari (iOS)
          </StyledLink>
        </li>
        <li>
          <StyledLink href="www.windowsphone.com/pl-pl/how-to/wp7/web/changing-privacy-and-other-browser-settings">
            Windows Phone
          </StyledLink>
        </li>
      </StyledPolicySubList>
...
export default PolicyPrivacySection
